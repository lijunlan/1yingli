...
function refresh() {
	$.ajax({
		...
		data : "{'style':'manager','method':'getApplicationFormList','mid':'"
				+ $.cookie("mid") + "'}",
		async : false,
...
function accept(afid) {
	...
	$.ajax({
		...
		type : "POST",
		url : "http://service.1yingli.cn/yiyingliService/manage",
		data : "{'style':'manager','method':'doneApplicationForm','mid':'"
				+ $.cookie("mid") + "','afId':'" + afid
				+ "','accept':'true','description':'" + description + "'}",
		async : false,
		error : function(request) {
			alert("Connection error");
		},
...
function refuse(afid) {
	...
	$.ajax({
		...
		data : "{'style':'manager','method':'doneApplicationForm','mid':'"
				+ $.cookie("mid") + "','afId':'" + afid
				+ "','accept':'false','description':'" + description + "'}",
		async : false,
		error : function(request) {
			alert("Connection error");
		},
