...
var changeTable = function (data) {
	...
	row += "<tr><th>简介</th><td colspan=6>" + data.introduce
	+ "</td></tr>";
	row += "<tr><th>粉丝数</th><td colspan=6>" + data.likeNo
	+ "</td></tr>";
	row += "<tr><th>地址</th><td colspan=6>" + data.address
	+ "</td></tr>";
	row += "<tr><th>交流方式</th><td colspan=6>" + data.talkWay
	+ "</td></tr>";
	row += "<tr><th>评论数量</th><td colspan=6>" + data.commentNo
	+ "</td></tr>";
	row += "<tr><th>每周咨询次数</th><td colspan=6>" + data.timeperweek
	+ "</td></tr>";
	row += "<tr><th>空闲时间</th><td colspan=6>" + data.freeTime
	+ "</td></tr>";
	row += "<tr><th>服务价格</th><td colspan=6>" + data.price
	+ "</td></tr>";
	...
	row += "<tr><th rowspan=" + tipsCount + ">标签</th>"
	+ processTips(data.tips);
