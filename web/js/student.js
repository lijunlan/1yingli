...
function getTotalPage(){
    ...
    $.ajax({
        ...
        data : "{'style': 'user', 'method': 'getOrderCount', 'uid': '"+$.cookie('uid')+"'}",
        async : false,
