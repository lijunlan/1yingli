...
function openshow(i,orderId){
    switch (i){
        ...
        case 256:
            $(".mark").show();
            $(".no1").slideDown().html("<p>请和学员协商后尽快确认时间</p><p>请在下面输入预约时间并确认<span style='color:red;'>(以北京时间为准)</span></p><div class='order-step'><div class='yuan yuan-01'><span>1</span></div><div class='xian xian-01'></div><div class='yuan yuan-01'><span>2</span></div><div class='xian xian-01'></div><div class='yuan yuan-01'><span>3</span></div><div class='xian'></div><div class='yuan'><span>4</span></div><div class='xian'></div><div class='yuan'><span>5</span></div></div><ul class='order-step-text'><li>学员申请</li><li>导师确认</li><li>协商时间</li><li>服务进行</li><li>双方评价</li></ul><input id='cd' type='date' style='float: left;margin-left: 200px;margin-top:10px;border: 1px solid rgba(0,0,0,0.3);border-radius: 5px;'/><input id='ct' type='time' style='float: left;margin-top:10px;border: 1px solid rgba(0,0,0,0.3);border-radius: 5px;'/><button id='ttime' style='margin: 17px 70px 0px 200px;float:left;'>确认时间</button><button id='back256' style='margin: 16.5px 0px;float:left;'>返回</button><img class='Tutor_icon' src='http://image.1yingli.cn/img/schedule_close.png' alt=''/><div id='alt' style='color:red; display:none;'>日期与时间必填！</div></div>");
            $(".Tutor_icon").click(function(){
                $(".no1").slideUp();
                $(".mark").hide(); 
            });
...
function detail(oid){
        ...
        $.ajax({
            ...
            data : $.toJSON(toSend),
                ...
                success : function(data, textStatu) {
                    var json = eval("(" + data + ")"); 
                    $(".details").fadeIn().html("<img class='Tutor_icon' src='http://image.1yingli.cn/img/order_close_icon.png' alt=''/><div style='width:822px; height:34px;border-top-left-radius:10px;border-top-right-radius:10px;background-color:#eeeeee;text-align: -webkit-center;'><div style='width:240px;height:20px;font-size: 16px; color: #000;font-weight: bolder;padding-top: 10px;overflow:hidden; white-space: nowrap; text-overflow:ellipsis;'>"+json.title+"</div> </div><div style='width:173px; height:440px;margin:49px 0 0 60px;float:left;'><div style='width:173px; height:173px; border-radius:10px;float:left;'><img src=\""+(json.iconUrl==""?"http://image.1yingli.cn/img/img.png":json.iconUrl)+"\" style='width:173px; height:173px;' alt=''/></div><div style='width:173px; height:30px; font-size:16px; text-align:center; border-radius:10px;float:left;margin:10px 0 0 0;'>"+json.name+"</div><div style='width:173px; height:30px; font-size:42px; text-align:center; border-radius:10px;float:left;margin:30px 0 0 0;'>"+json.price+"元</div></div><div style='width:533px; height:120px; background-color:#FFF;float:left;margin:49px 0 0 37px;'><p style='font-size:16px;font-weight: bolder;'>学员提的问题:</p><p style='width:520px;height:97px;border:1px solid #eeeeee;margin: 0;overflow-y: auto;overflow-x: hidden;word-break: break-word;'>"+json.question+"</p></div><div style='width:533px; height:120px; background-color:#FFF;float:left;margin:20px 0 0 37px;'><p style='font-size:16px;font-weight: bolder;'>学员目前状况:</p><p style='width:520px;height:97px;border:1px solid #eeeeee;margin: 0;overflow-y: auto;overflow-x: hidden;word-break: break-word;'>"+json.userIntroduce+"</p></div><div style='width:533px; height:50px; background-color:#FFF;float:left;margin:20px 0 0 37px;'><p style='font-size:16px;font-weight: bolder;'>预约时间:</p><p style='width:520px;height:35px;border:1px solid #eeeeee;margin: 0;overflow-y: auto;overflow-x: hidden;word-break: break-word;'>"+json.selectTimes+"</p></div><div style='width:533px; height:50px; background-color:#FFF;float:left;margin:20px 0 0 37px;'><p style='font-size:16px;font-weight: bolder;'>联系方式:</p><p style='width:150px;height:15px;font-size:13px;margin:5px 20px 0 0; float:left;'>手机号码："+json.phone+"</p><p style='width:150px;height:15px;font-size:13px;margin:5px 20px 0 0; float:left;'>微信："+json.contact+"</p><p style='width:180px;height:15px;font-size:13px;margin:5px 0 0 0; float:left;'>邮箱："+json.email+"</p></div><div style='width:822px; height:34px;border-bottom-left-radius:10px;border-bottom-right-radius:10px;background-color:#eeeeee;text-align: -webkit-center;float:left;'><div style='width:400px;height:20px;font-size: 14px; color: #000; padding-top: 8px;'>订单号："+json.orderId+"</div> </div>");
                    $(".Tutor_icon").click(function(){
                            $(".mark").hide();
                            $(".details").fadeOut();
                        });
...
//拒绝理由弹窗
    // $("#3").click(function(){
    //     $("#refuse").show().html("<div style='z-index:150;'><img src='images/edge.png' style='width:20px; height:20px; position:absolute; top:400px; left:55%;'><div style='width:150px; height:160px; background:#56bbe8; position:absolute; top:380px; left:56%; border-top-left-radius:8px;border-top-right-radius:8px;'><div style='font-size:16px; font-family:lantingxihei; color:#FFF; margin:10px 16px'>请选择拒绝理由</div><ul class='##'><li><div class='##' style='margin:10px'><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:40px;left:20%;'>学员信息不完整</div></div></li><li><div class='##' style='margin:10px'> <input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:70px;left:20%;'>临时有事</div></div></li><li><div class='##' style='margin:10px'><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:100px;left:20%;'>其他原因</div></div></li></ul></div><div style='width:150px; height:40px; background:#FFF; position:absolute; top:540px; left:56%;border-bottom-right-radius:8px;border-bottom-left-radius:8px;z-index:300;'><div id='Tclose' style='width:40px; height:20px; font-size:14px; color:#FFF; background:#d3d3d3; position:absolute; top:5px; left:10%; padding:2px 8px; border-radius:8px;'>取 消</div><div id='tconfirm' style='width:40px; height:20px; font-size:14px; color:#FFF; background:#56bbe8; position:absolute; top:5px; left:50%; padding:2px 8px; border-radius:8px;'>确 认</div></div></div>")
    //     $("#Tclose").click(function(){
    //         $("#refuse").hide();
    //     });
    //     $("#tconfirm").click(function(){
    //         $("#refuse").hide();
    //         var tval = $('#refuse input[name="choice"]:checked ').val();
    //     });
    // }) ;
//     $("#").click(function(){
//         $("#").show().html(<div>
//     <img src='images/edge.png' style='width:20px; height:20px; position:absolute; top:400px; left:55%;'>
//     <div style='width:150px; height:160px; background:#56bbe8; position:absolute; top:380px; left:56%; border-top-left-radius:8px;border-top-right-radius:8px;'>
//         <div style='font-size:16px; font-family:lantingxihei; color:#FFF; margin:10px 16px'>请选择退款原因</div>
//         <ul class='##'>
//             <li>
//                 <div class='##' style='margin:10px'>
//                     <h3><label><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:40px;left:20%;'>不想咨询了</div></label></h3>
//                 </div>
//             </li>
//             <li>
//                 <div class='##' style='margin:10px'> 
//                     <h3><label><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:70px;left:20%;'>临时有事</div></label></h3>
//                 </div>
//             </li>
//             <li>
//                 <div class='##' style='margin:10px'>
//                     <h3><label><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:100px;left:20%;'>其他原因</div></label></h3>
//                 </div>
//             </li>
//         </ul>
//     </div>
//     <div style='width:150px; height:40px; background:#FFF; position:absolute; top:540px; left:56%;border-bottom-right-radius:8px;border-bottom-left-radius:8px;'>
//         <div id='##' style='width:40px; height:20px; font-size:14px; color:#FFF; background:#d3d3d3; position:absolute; top:5px; left:10%; padding:2px 8px; border-radius:8px;'>取 消</div>
//         <div id='##' style='width:40px; height:20px; font-size:14px; color:#FFF; background:#56bbe8; position:absolute; top:5px; left:50%; padding:2px 8px; border-radius:8px;'>确 认</div>
//     </div>
//     </div>)
//     })    
//     $("#").click(function(){
...
//             <li>
//                 <div class='##' style='margin:10px'>
//                     <h3><label><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:40px;left:20%;'>导师未服务</div></label></h3>
//                 </div>
//             </li>
//             <li>
//                 <div class='##' style='margin:10px'> 
//                     <h3><label><input name='choice' type='radio' placeholder='' style='width:15px; height:15px;'><div style='font-size:14px; color:#FFF; position:absolute; top:70px;left:20%;'>服务不满意</div></label></h3>
//                 </div>
//             </li>
//             <li>
//                 <div class='##' style='margin:10px'>
