...
#import "LoginModal.h"
@interface OrderUnloginViewController ()<lcForOrderInterface>
@property (nonatomic,retain)LoginModal *loginUser;
@end

@implementation OrderUnloginViewController
...
- (void)viewDidLoad {
    ...
    imageV.image = [UIImage imageNamed:@"order_bg.png"];
    ...
    [label1 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(view.mas_left).offset(self.view.frame.size.width / 2 - 80);
        make.right.equalTo(view.mas_right).offset(-(self.view.frame.size.width / 2 - 80));
