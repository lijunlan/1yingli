//
//  CollectionUnloginViewController.m
//  one_mile_01
//
...
@interface CollectionUnloginViewController ()<lcForCollectionInterface>

@property (nonatomic, strong) LoginModal *loginUser;

@end

@implementation CollectionUnloginViewController

-(instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        
        //self.loginUser = [[LoginModal alloc] init];
    }
