//
//  tutorMySelfAppriseTableViewCell.m
//  one_mile_01
//
...
#import "tutorMySelfAppriseTableViewCell.h"

@implementation tutorMySelfAppriseTableViewCell
...
-(void)creatCellView{
    ...
    self.label1 = [[UILabel alloc]initWithFrame:CGRectMake(bgImageView.frame.origin.x + 5 , bgImageView.frame.origin.y + 10, bgImageView.frame.size.width - 10, 30)];
    self.label1.backgroundColor = [UIColor redColor];
    [self.contentView addSubview:self.label1];
    
    self.label2 = [[UILabel alloc]initWithFrame:CGRectMake(self.label1.frame.origin.x , self.label1.frame.origin.y + self.label1.frame.size.height + 10, self.label1.frame.size.width, 30)];
    ...
    self.imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(self.label5.frame.origin.x, self.label5.frame.origin.y + 3,50 , 50)];
