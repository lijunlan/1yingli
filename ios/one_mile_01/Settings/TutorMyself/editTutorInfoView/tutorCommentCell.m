...
@implementation tutorCommentCell
...
-(void)creatCellView{
    ...
    self.label1 = [[UILabel alloc]initWithFrame:CGRectMake(self.bgImageView.frame.origin.x + 15 , self.bgImageView.frame.origin.y + 15, self.bgImageView.frame.size.width - 30, 40)];
...
//        self.label2.backgroundColor = [UIColor redColor];
    ...
    self.linelebel = [[UILabel alloc]initWithFrame:CGRectMake(self.label1.frame.origin.x , self.label2.frame.origin.y + self.label2.frame.size.height + 5, self.bgImageView.frame.size.width - 25, 0.5)];
    self.linelebel.backgroundColor = [UIColor blackColor];
    [self.contentView addSubview:self.linelebel];
    
    self.label5 = [[UILabel alloc]initWithFrame:CGRectMake(self.label2.frame.origin.x + 5 , self.label2.frame.origin.y + self.label2.frame.size.height + 10, self.label2.frame.size.width - 10, 0.5)];
    //    self.label5.backgroundColor = [UIColor blackColor];
    [self.contentView addSubview:self.label5];
    
    self.imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(self.label5.frame.origin.x - 3, self.label5.frame.origin.y ,50 , 50)];
    ...
    self.label3 = [[UILabel alloc]initWithFrame:CGRectMake(self.imageView1.frame.origin.x + self.imageView1.frame.size.width + 8 , self.label5.frame.origin.y + 2,200,25)];
...
-(void)setlabel2Text:(NSString *)text{
    ...
    self.linelebel.frame = CGRectMake(self.label1.frame.origin.x , self.label2.frame.origin.y + self.label2.frame.size.height + 3, self.bgImageView.frame.size.width - 40, 0.5);
    ...
    self.bgImageView.frame = CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, self.label4.frame.origin.y + 50);
