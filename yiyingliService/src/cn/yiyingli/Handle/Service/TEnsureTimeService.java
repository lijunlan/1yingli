...
public class TEnsureTimeService extends MsgService {
	...
	protected boolean checkData() {
		return getData().containsKey("uid") && getData().containsKey("teacherId") && getData().containsKey("okTime")
				&& getData().containsKey("orderId");
	}
	...
	public void doit() {
		...
		NotifyUtil.notifyUser(order.getCustomerPhone(), order.getCustomerEmail(),
				"尊敬的用户，订单号" + order.getOrderNo() + "，已经约定好咨询时间(" + okTime + ")，请等待咨询，并在一周内确认咨询或申请退款，系统会在1周后自动确认咨询成功",
