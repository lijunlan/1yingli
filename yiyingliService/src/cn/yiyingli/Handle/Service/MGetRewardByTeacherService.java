...
public class MGetRewardByTeacherService extends MMsgService {
	...
	public boolean checkData() {
		return super.checkData() && getData().containsKey("page") && getData().containsKey("teacherId");
	}
	...
	public void doit() {
		...
		List<Reward> rewards = getRewardService().queryListByTeacher(getData().getLong("teacherId"), page,
				RewardService.PAGE_SIZE);
