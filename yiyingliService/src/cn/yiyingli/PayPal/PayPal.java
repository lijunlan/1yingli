...
//	nvpstr.append( "&PAYMENTREQUEST_0_SELLERPAYPALACCOUNTID=").append(this.getSellerEmail();
	...
	if(isSet(checkoutDetails.get("PAYMENTREQUEST_0_CURRENCYCODE") )){
		nvpstr.append( "&PAYMENTREQUEST_0_CURRENCYCODE=").append(checkoutDetails.get("PAYMENTREQUEST_0_CURRENCYCODE"));
	}
	...
	//add by LP
	if(isSet(checkoutDetails.get("REQCONFIRMSHIPPING")))
		nvpstr.append( "&REQCONFIRMSHIPPING="+ checkoutDetails.get("REQCONFIRMSHIPPING"));
	...
	if(isSet(checkoutDetails.get("L_PAYMENTREQUEST_0_ITEMCATEGORY0")))
		nvpstr.append( "&L_PAYMENTREQUEST_0_ITEMCATEGORY0="+ checkoutDetails.get("L_PAYMENTREQUEST_0_ITEMCATEGORY0"));
	
	if(isSet(checkoutDetails.get("PAYMENTREQUEST_0_PAYMENTACTION")))
		nvpstr.append( "&PAYMENTREQUEST_0_PAYMENTACTION="+ checkoutDetails.get("PAYMENTREQUEST_0_PAYMENTACTION"));
...
public HashMap confirmPayment(Map<String,String>checkoutDetails, String serverName)
{
	...
	//nvpstr.append( "&PAYMENTREQUEST_n_NOTIFYURL=").append("http://www.sdll18.com/checkout-mini-browser-test/Notify");
