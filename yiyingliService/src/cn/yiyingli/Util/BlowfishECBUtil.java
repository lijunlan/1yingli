 ...
 * 
 * @author SDLL18 2015-7-7
 */
public class BlowfishECBUtil {
	 ...
	 *            - 密钥
	 */
	public BlowfishECBUtil(String bfkey) {
	 ...
	 *            - 密钥
	 */
	public BlowfishECBUtil(byte[] bfkey) {
		BlowfishInit(bfkey);
	}
	...
	private static BlowfishECBUtil singleInstance;

	public static BlowfishECBUtil getSingleInstance() {
		if (singleInstance == null) {
			singleInstance = new BlowfishECBUtil("HUZHONGKAI");
		}
	...
	public static void main(String[] args) {
		...
		// BlowfishECB bf = new BlowfishECB("E0FEE0FEF1FEF1FE");
		// System.out.println(hexString(bf.encrypt(hex2byte("0756D8E0774761D2"))));
		// System.out.println(hexString(bf.decrypt(bf.encrypt(hex2byte("0756D8E0774761D2")))));
		BlowfishECBUtil bf = BlowfishECBUtil.getSingleInstance();
		long startTime = System.currentTimeMillis();
		System.out.println(bf.encrypt("0001"));
		System.out.println(bf.decrypt(bf.encrypt("0001")));
