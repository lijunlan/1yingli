...
//		System.out.println((map.finishByJson()));
	...
	private static boolean send(String json) throws UnsupportedEncodingException {
		...
		Map<String, String> map = Json.getMap(r);
